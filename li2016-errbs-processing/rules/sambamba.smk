...
rule sambamba_sort:
    input:
        RESULT_DIR / '02_bismark' / '{sample}' / '{sample}.bismark.bam'
    output:
        RESULT_DIR / '02_bismark' / '{sample}' / '{sample}.bismark.sorted.bam'
    params:
        extra = SSS['extra'],
...
rule sambamba_index:
    input:
        RESULT_DIR / '02_bismark' / '{sample}' / '{sample}.bismark.sorted.bam'
    output:
        RESULT_DIR / '02_bismark' / '{sample}' / '{sample}.bismark.sorted.bam.bai'
...
rule sambamba_flagstat:
    input:
        RESULT_DIR / '02_bismark' / '{sample}' / '{sample}.bismark.sorted.bam'
    output:
        RESULT_DIR / '02_bismark' / '{sample}' / '{sample}.bismark.sorted.bam.flagstat'
    threads: config['threads']['sambamba_flagstat']
